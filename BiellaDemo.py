...
# MAGIC ## IoT Dataset
# MAGIC 
# MAGIC List of IoT Devices with IP addresses. In addition to the IP address, the file contains the geographic information for each device entry:
# MAGIC 
...
.groupby('cn').avg('humidity', 'temp')\
.write.csv('/tmp/test_aggregated_iot.csv')
...
# MAGIC %md
# MAGIC Do you notice the trailing `/`?
